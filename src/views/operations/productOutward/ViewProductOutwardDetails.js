                ...
                <Table stickyHeader aria-label="sticky table">
                  <TableHead>
                    <TableRow className={classes.shadedTableHeader}>
                      ...
                      <TableCell className={classes.tableHeadText}>WEIGHT</TableCell>
                      ...
                      <TableCell className={classes.tableHeadText}>SENT QTY</TableCell>
                      <TableCell className={classes.tableHeadText}>REMAINING QTY</TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
