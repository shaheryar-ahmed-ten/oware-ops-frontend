                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={6}>
                      <TextField
                        ...
                        fullWidth
                        variant="filled"
                        value={selectedProductOutward.Vehicle.Car.CarMake.name + ' ' + selectedProductOutward.Vehicle.Car.CarModel.name}
                      />
                    </Grid>
                    <Grid item xs={6}>
                      <TextField
                        ...
                        fullWidth
                        variant="filled"
                        value={selectedProductOutward.Vehicle.registrationNumber}
                      />
                    </Grid>
                    <Grid item xs={6}>
                      <TextField
