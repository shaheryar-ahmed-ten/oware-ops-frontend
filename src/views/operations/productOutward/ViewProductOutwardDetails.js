          ...
          <Grid container spacing={2}>
            <Grid container item xs={6}>
              ...
              <Grid item xs={6}>
                <Box display="block" displayPrint="block">
                  {
                    selectedProductOutward.DispatchOrder.Inventory.Warehouse
                      .name
                  }
                </Box>
              </Grid>
              ...
              <Grid item xs={6}>
                <Box display="block" displayPrint="block">
                  {`${selectedProductOutward.User.firstName || ""} ${
                    selectedProductOutward.User.lastName || ""
                  }`}
                </Box>
              </Grid>
            </Grid>
            <Grid container item xs={6}>
              ...
              <Grid item xs={6}>
                <Box display="block" displayPrint="block">
                  {selectedProductOutward.Vehicle
                    ? selectedProductOutward.Vehicle.registrationNumber
                    : selectedProductOutward.externalVehicle
                    ? selectedProductOutward.externalVehicle
                    : "-"}
                </Box>
              </Grid>
              ...
              <Grid item xs={6}>
                <Box display="block" displayPrint="block">
                  {selectedProductOutward.externalVehicle &&
                  isRequired(selectedProductOutward.externalVehicle)
                    ? "Customer Provided"
                    : "Oware Provided"}
                </Box>
              </Grid>
            ...
            <Grid container item xs={12}>
              {selectedProductOutward.DispatchOrder.Inventories.map(
                (order, idx) => {
                  let remainingQt = 0,
                    sentQt = 0;
                  ...
                  if (targetedPoInv) {
                    return targetedPoInv.OutwardGroup.InventoryDetail.map(
                      (invDetail) => {
                        return (
                          <>
                            <Grid
