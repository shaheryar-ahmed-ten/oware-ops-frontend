...
function WarehouseDetailsView({ open, handleClose, selectedWarehouse }) {
    const classes = useStyles();
    console.log(selectedWarehouse,open)
  return (
    selectedWarehouse ?
                ...
                <Grid container spacing={2}>
                    ...
                    {selectedWarehouse && selectedWarehouse.locationLatlng ? (
                        <Grid container item xs={12} spacing={3} style={{ minHeight: 400, marginBottom: 20 }}>
                            ...
                            <GoogleMap
                                singleLocationLatlng={selectedWarehouse.locationLatlng}
