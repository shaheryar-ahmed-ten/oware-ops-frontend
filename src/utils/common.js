...
export const dateFormat = value => moment(value).utcOffset(value).format('DD-MM-yyyy hh:mm A');

export const dateToPickerFormat = value => moment(value).utcOffset(value).format('yyyy-MM-DDTHH:mm')
